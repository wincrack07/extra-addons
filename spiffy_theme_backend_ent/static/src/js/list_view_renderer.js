...
var spiffyDocumentViewer = require("spiffy_theme_backend_ent.spiffyDocumentViewer");
...
import { useService } from "@web/core/utils/hooks";
    ...
    patch(ListRenderer.prototype, "spiffy_theme_backend_ent.ListRenderer", {
      setup() {
          this._super();
          var self = this
          ...
          // var first_record = this.props.list.records[0].id
