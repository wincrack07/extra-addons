odoo.define('spiffy_theme_backend_ent.MenuJs', function (require) {
    'use strict';
     ...
     var qweb = core.qweb;
     var ColorPallet = require('spiffy_theme_backend_ent.ColorPalletJS')
         ...
         _searchPages: function(){
            ...
            if ($selected_search_mainmenu_name != '0'){
             ...
             this.$search_modal_results.html(
                 core.qweb.render("spiffy_theme_backend_ent.MenuSearchResults", {
                     results: results,
                     widget: this,
                 })
             );
